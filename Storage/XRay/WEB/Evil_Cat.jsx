  ...
  return React.createElement("main", { className: "cat-engine", onPointerDown: startSound },
    React.createElement("style", null, `
      ...
      *{box-sizing:border-box}.cat-engine{isolation:isolate;position:relative;min-height:100svh;overflow:hidden;background:radial-gradient(ellipse 72% 61% at 50% 49%,#25090e 0%,#0d0708 43%,var(--void) 76%);color:var(--paper);font-family:Inter,ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif}.cat-engine:before{content:"";position:absolute;z-index:-1;inset:0;pointer-events:none;opacity:.075;background-image:repeating-linear-gradient(0deg,transparent 0,transparent 3px,#fff 4px),repeating-linear-gradient(90deg,transparent 0,transparent 95px,rgba(255,70,82,.4) 96px)}.cat-engine:after{content:"";position:absolute;z-index:-1;inset:-18%;pointer-events:none;background:radial-gradient(circle at center,transparent 0 16%,rgba(228,28,45,.1) 28%,transparent 48%),conic-gradient(from 30deg,transparent,rgba(228,28,45,.075),transparent 28%);animation:orbit 16s linear infinite}@keyframes orbit{to{transform:rotate(1turn)}}
      ...
      .center-stage{position:absolute;inset:0;display:grid;place-items:center;padding:92px 20px 100px}.center-stage:before{content:"";position:absolute;width:min(66vw,410px);aspect-ratio:1;border-radius:50%;background:radial-gradient(circle,rgba(255,54,70,.28),rgba(143,9,22,.16) 30%,rgba(34,5,9,.07) 55%,transparent 70%);filter:blur(3px);animation:breathe 3.8s ease-in-out infinite}.cat-wrap{position:relative;z-index:1;display:grid;place-items:center;width:min(52vw,260px);height:min(45svh,330px);filter:drop-shadow(0 0 28px rgba(228,28,45,.49))}.cat-wrap:before{content:"";position:absolute;z-index:-1;inset:7%;border:1px solid rgba(255,83,97,.22);border-radius:50%;box-shadow:inset 0 0 34px rgba(228,28,45,.14),0 0 50px rgba(228,28,45,.12);animation:spin 15s linear infinite}.aura-lottie{position:absolute;inset:0;z-index:0;opacity:.78;mix-blend-mode:screen}.aura-lottie svg{width:100%!important;height:100%!important}.cat-figure{position:absolute;z-index:1;width:84%;height:84%;overflow:visible;transform-origin:50% 68%;animation:cat-breathe 2.9s ease-in-out infinite}.cat-body{fill:#080607;stroke:#68101b;stroke-width:1.5}.cat-detail{fill:none;stroke:#421018;stroke-width:1.3;opacity:.8}.cat-tail{fill:none;stroke:#080607;stroke-width:17;stroke-linecap:round;stroke-linejoin:round;transform-origin:74% 72%;animation:tail 1.55s ease-in-out infinite}.cat-tail-line{fill:none;stroke:#68101b;stroke-width:1.2;opacity:.7}.cat-eye{fill:#ff2335;filter:drop-shadow(0 0 6px #ff1023);animation:eyes 1.4s ease-in-out infinite}.cat-pupil{fill:#190004}.cat-wrap svg{position:absolute;inset:0}.cat-fallback{position:relative;z-index:2;color:var(--red-hot);font:24px ui-monospace;letter-spacing:18px;filter:drop-shadow(0 0 10px var(--red))}.crosshair{position:absolute;width:min(66vw,340px);aspect-ratio:1;border:1px solid rgba(255,189,193,.12);border-radius:50%;pointer-events:none}.crosshair:before,.crosshair:after{content:"";position:absolute;background:rgba(255,189,193,.16)}.crosshair:before{height:1px;left:-10%;right:-10%;top:50%}.crosshair:after{width:1px;top:-10%;bottom:-10%;left:50%}.hero-copy{position:absolute;z-index:2;left:clamp(18px,6vw,92px);bottom:max(24px,env(safe-area-inset-bottom));max-width:325px}.hero-copy p{margin:0 0 12px;color:var(--ash);font:8px/1.4 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.15em}.hero-copy p i{display:inline-block;width:22px;height:1px;margin-right:9px;vertical-align:middle;background:var(--red);box-shadow:0 0 8px var(--red)}.hero-copy h1{margin:0;font-size:clamp(30px,4vw,54px);line-height:.91;letter-spacing:-.065em;font-weight:300;text-shadow:0 5px 34px #000}.hero-copy h1 em{font-style:normal;color:transparent;-webkit-text-stroke:1px rgba(255,174,179,.65);filter:drop-shadow(0 0 12px rgba(228,28,45,.3))}.corner{position:absolute;z-index:2;width:14px;height:14px;border-color:rgba(255,118,127,.42);border-style:solid;pointer-events:none}.tl{left:12px;top:12px;border-width:1px 0 0 1px}.tr{right:12px;top:12px;border-width:1px 1px 0 0}.bl{left:12px;bottom:12px;border-width:0 0 1px 1px}.br{right:12px;bottom:12px;border-width:0 1px 1px 0}.wake{position:absolute;z-index:4;left:50%;top:calc(max(16px,env(safe-area-inset-top)) + 73px);transform:translateX(-50%);padding:8px 12px;color:#d8bfc2;border:1px solid rgba(255,83,97,.26);background:rgba(30,7,10,.55);font:7px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.15em;opacity:0;transition:.3s;pointer-events:none}.wake.show{opacity:1}.wake i{color:var(--red-hot);font-style:normal}@keyframes pulse{50%{opacity:.35;transform:scale(.75)}}@keyframes spin{to{transform:rotate(1turn)}}@keyframes breathe{50%{transform:scale(1.1);opacity:.68}}@keyframes cat-breathe{50%{transform:translateY(-5px) scale(1.025)}}@keyframes tail{50%{transform:rotate(-12deg)}}@keyframes eyes{50%{opacity:.48;filter:drop-shadow(0 0 14px #ff1023)}}@media(max-width:820px){.side-panel,.telemetry{display:none}.hero-copy{left:50%;bottom:calc(18px + env(safe-area-inset-bottom));transform:translateX(-50%);width:calc(100% - 42px);text-align:center}.cat-wrap{width:min(60vw,245px);height:min(44svh,300px)}.center-stage{padding-bottom:130px}.hero-copy h1{font-size:32px}.state span{display:none}}@media(prefers-reduced-motion:reduce){.cat-engine:after,.cat-wrap:before,.center-stage:before,.brand-mark:before,.state i,.cat-figure,.cat-tail,.cat-eye{animation:none}}
    `),
    ...
    React.createElement("section", { className: "center-stage", "aria-label": "Animated evil cat" },
      ...
      React.createElement("div", { className: "cat-wrap", ref: holder },
        React.createElement("svg", { className: "cat-figure", viewBox: "0 0 240 260", role: "img", "aria-label": "Black cat with red eyes" },
          React.createElement("path", { className: "cat-tail", d: "M174 194 C226 219 229 155 199 164 C181 170 187 198 214 190" }),
          React.createElement("path", { className: "cat-tail-line", d: "M174 194 C226 219 229 155 199 164 C181 170 187 198 214 190" }),
          React.createElement("path", { className: "cat-body", d: "M55 132 L43 52 L84 77 Q120 58 157 77 L198 52 L185 134 Q206 164 190 217 Q166 243 120 245 Q74 243 50 217 Q34 164 55 132 Z" }),
          React.createElement("path", { className: "cat-detail", d: "M63 142 Q120 169 179 142 M75 210 Q120 229 167 210" }),
          React.createElement("path", { className: "cat-eye", d: "M77 138 Q94 123 110 139 Q95 156 77 138 Z" }),
          React.createElement("path", { className: "cat-eye", d: "M130 139 Q146 123 163 138 Q145 156 130 139 Z" }),
          React.createElement("path", { className: "cat-pupil", d: "M94 132 L98 145 L102 132 Z" }),
          React.createElement("path", { className: "cat-pupil", d: "M140 132 L144 145 L148 132 Z" }),
          React.createElement("path", { className: "cat-detail", d: "M116 157 L123 157 M112 164 Q120 169 128 164" })
        )
      )
    ),
